    ...
    variables.city == null ? "Toronto" : variables.city
          ...
          <ul class="${variables.socialMediaPosition}">
            <li><a href="https://x.com/${
              variables.twitter == null ? "Soyeduardjose" : variables.twitter
            }">
            <i class="fab fa-twitter"></i></a></li>
            <li><a href="https://github.com/${
              variables.github == null ? "Eduard-jcs" : variables.github
            }">
            <i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/in/${
              variables.linkedin == null
                ? "eduard-jose-cárdenas-santiago-259a63231/"
                : variables.linkedin
...
window.onload = function() {
  window.variables = {
    ...
    avatarURL:
      "https://www.yunbitsoftware.com/blog/wp-content/uploads/2020/03/364146-PB1OW0-666.jpg",
